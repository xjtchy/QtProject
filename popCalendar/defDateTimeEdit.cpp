...
void DefDateTimeEdit::setMyStytle()
{
	...
	//QLabel
	strTemp.append("QLabel#CalLabel{border:0px solid lightgray; color:rgb(0, 159, 149);}");
	...
	strTemp.append("QComboBox#CalComboBox{border:0px; background-color:rgb(0, 159, 149); \
				   ...
				   image:url(:/MyCalendar/images/ad.png);}\
	...
	strTemp.append("QTimeEdit#CalTimeEdit::up-arrow{  image:url(:/MyCalendar/images/au.png);}");
	...
	strTemp.append("QTimeEdit#CalTimeEdit::down-arrow{  image:url(:/MyCalendar/images/ad.png);}");

	////QDateTimeEdit
	//strTemp.append("QDateTimeEdit{border:1px solid gray; height:24px; }");
	//strTemp.append("QDateTimeEdit::down-arrow{image:url(:/MyCalendar/images/calendar.png);}");
