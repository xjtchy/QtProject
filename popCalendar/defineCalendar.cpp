	...
	: QCalendarWidget(parent)
{
	...
	QSize c = this->size();
	int b = this->width();
	QSize size = this->layout()->sizeHint();
...
void DefineCalendar::InitWidgets()
{
	...
	pushBtn_YL->setIcon(QPixmap(":/MyCalendar/images/al.png"));

	pushBtn_YR->setFixedSize(nO,nO);
	pushBtn_YR->setIconSize(QSize(nI,nI));
	pushBtn_YR->setIcon(QPixmap(":/MyCalendar/images/ar.png"));

	pushBtn_ML->setFixedSize(nO,nO);
	pushBtn_ML->setIconSize(QSize(nI,nI));
	pushBtn_ML->setIcon(QPixmap(":/MyCalendar/images/al.png"));

	pushBtn_MR->setFixedSize(nO,nO);
	pushBtn_MR->setIconSize(QSize(nI,nI));
	pushBtn_MR->setIcon(QPixmap(":/MyCalendar/images/ar.png"));
	...
	//int a = this->width();
	//label_Time->setText("K"+QString::number(a));
